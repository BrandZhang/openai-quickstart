...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--target_language',type=str,help='The target language into which languages')
        self.parser.add_argument('--pages',type=int,help='Page limit for reading pdf at one time')
